...
pub struct World {
    ...
    pub _world: bevy_ecs::world::World,
...
impl World {
    pub fn new() -> Self {
        World {
            ...
            spawned_entities: 0,
            active_entities: 0,
            _world: bevy_ecs::world::World::new(),
    ...
    //         self.schedule.run(&mut self._world);
    //         self.tick()
    //     }
    // }
    ...
    //                 self._world.spawn().insert(player);
    ...
    //                 // let mut query = self._world.query::<(Entity, &Player)>();
    //                 // for (entity, player) in query.iter_mut(&mut self._world) {
    //                 //     if player.id == id {
    //                 //         self._world.despawn(entity);
    //                 //         self.timer.last_action = Instant::now()
    //                 //             .duration_since(self.timer.start_time)
    //                 //             .as_secs();
    //                 //     }
    ...
    //                 // if let Ok(player) = self._world.get(id) {
